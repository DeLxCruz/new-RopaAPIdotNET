...
namespace Infrastructure.Data.Migrations
{
    ...
    [Migration("20231023020953_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.Cliente", b =>
                {
                    b.HasOne("Core.Entities.Municipio", "Municipios")
                        .WithMany("Clientes")
                        .HasForeignKey("IdMuncipio")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.Entities.TipoPersona", "TiposPersona")
                        .WithMany("Clientes")
            ...
            modelBuilder.Entity("Core.Entities.Estado", b =>
                {
                    b.HasOne("Core.Entities.TipoEstado", "TiposEstado")
                        .WithMany("Estados")
                        .HasForeignKey("IdTipoEstado")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("TiposEstado");
                });
            ...
            modelBuilder.Entity("Core.Entities.Prenda", b =>
                {
                    ...
                    b.HasOne("Core.Entities.TipoProteccion", "TiposProteccion")
                        .WithMany("Prendas")
